...
type ActiveMQArtemisSpec struct {
	...
	//v2alpha5 types
	Logging LoggingType `json:"logging,omitempty"`
}

type LoggingType struct {
	Logger    []LoggerType  `json:"loggers,omitempty"`
	Handler   []HandlerType `json:"handlers,omitempty"`
	Formatter []HandlerType `json:"formatters,omitempty"`
}
...
type HandlerType struct {
	...
	Properties []PropertyValueType `json:"properties,omitempty"`
}
