...
func (in *CustomInitImageType) DeepCopyInto(out *CustomInitImageType) {
	*out = *in
	if in.BrokerCfgRootDir != nil {
		in, out := &in.BrokerCfgRootDir, &out.BrokerCfgRootDir
		*out = new(string)
		**out = **in
	}
	if in.BrokerInstallScript != nil {
		in, out := &in.BrokerInstallScript, &out.BrokerInstallScript
		*out = new(string)
		**out = **in
	}
	if in.ImageSpec != nil {
