...
type ActiveMQArtemisInterface interface {
	Create(*v3alpha1.ActiveMQArtemis) (*v3alpha1.ActiveMQArtemis, error)
	Update(*v3alpha1.ActiveMQArtemis) (*v3alpha1.ActiveMQArtemis, error)
	UpdateStatus(*v3alpha1.ActiveMQArtemis) (*v3alpha1.ActiveMQArtemis, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v3alpha1.ActiveMQArtemis, error)
	List(opts v1.ListOptions) (*v3alpha1.ActiveMQArtemisList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v3alpha1.ActiveMQArtemis, err error)
...
func newActiveMQArtemises(c *BrokerV3alpha1Client, namespace string) *activeMQArtemises {
...
func (c *activeMQArtemises) Get(name string, options v1.GetOptions) (result *v3alpha1.ActiveMQArtemis, err error) {
	result = &v3alpha1.ActiveMQArtemis{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *activeMQArtemises) List(opts v1.ListOptions) (result *v3alpha1.ActiveMQArtemisList, err error) {
	result = &v3alpha1.ActiveMQArtemisList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("activemqartemises").
...
func (c *activeMQArtemises) Create(activeMQArtemis *v3alpha1.ActiveMQArtemis) (result *v3alpha1.ActiveMQArtemis, err error) {
	result = &v3alpha1.ActiveMQArtemis{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("activemqartemises").
...
func (c *activeMQArtemises) Update(activeMQArtemis *v3alpha1.ActiveMQArtemis) (result *v3alpha1.ActiveMQArtemis, err error) {
	result = &v3alpha1.ActiveMQArtemis{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("activemqartemises").
...
func (c *activeMQArtemises) UpdateStatus(activeMQArtemis *v3alpha1.ActiveMQArtemis) (result *v3alpha1.ActiveMQArtemis, err error) {
	result = &v3alpha1.ActiveMQArtemis{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("activemqartemises").
...
func (c *activeMQArtemises) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v3alpha1.ActiveMQArtemis, err error) {
	result = &v3alpha1.ActiveMQArtemis{}
